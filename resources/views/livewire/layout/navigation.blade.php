...
<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <!-- Settings Dropdown -->
            <div class="hidden sm:flex sm:items-center sm:justify-between sm:ms-6">
                @admin
                    <x-dropdown align="right" width="48">
                        ...
                        <x-slot name="content">
                            <x-dropdown-link :href="route('questions')" wire:navigate>
                                {{ __('Questions') }}
                            </x-dropdown-link>
                            <x-dropdown-link :href="route('quizzes')" wire:navigate>
                                {{ __('Quizzes') }}
                            </x-dropdown-link>
        ...
        @admin
            <div class="pt-4 pb-1 border-t border-gray-200 dark:border-gray-600">
                ...
                <div class="mt-3 space-y-1">
                    ...
                    <x-responsive-nav-link :href="route('quizzes')" :active="request()->routeIs('quizzes*')" wire:navigate>
                        {{ __('Quizzes') }}
                    </x-responsive-nav-link>
                    <x-responsive-nav-link :href="route('tests')" :active="request()->routeIs('tests*')">
                        {{ __('Tests') }}
                    </x-responsive-nav-link>
                </div>
            </div>
