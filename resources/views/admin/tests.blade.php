                            ...
                            <thead>
                                <tr>
                                    <th class="w-16 bg-gray-50 dark:bg-gray-600 px-6 py-3 text-left">
                                        <span class="text-xs font-medium uppercase leading-4 tracking-wider text-gray-500 dark:text-gray-300">{{ __('ID') }}</span>
                                    </th>
                                    <th class="bg-gray-50 dark:bg-gray-600 px-6 py-3 text-left">
                                        <span class="text-xs font-medium uppercase leading-4 tracking-wider text-gray-500 dark:text-gray-300">{{ __('User') }}</span>
                                    </th>
                                    <th class="bg-gray-50 dark:bg-gray-600 px-6 py-3 text-left">
                                        <span class="text-xs font-medium uppercase leading-4 tracking-wider text-gray-500 dark:text-gray-300">{{ __('Quiz') }}</span>
                                    </th>
                                    <th class="bg-gray-50 dark:bg-gray-600 px-6 py-3 text-left">
                                        <span class="text-xs font-medium uppercase leading-4 tracking-wider text-gray-500 dark:text-gray-300">{{ __('Result') }}</span>
                                    </th>
                                    <th class="bg-gray-50 dark:bg-gray-600 px-6 py-3 text-left">
                                        <span class="text-xs font-medium uppercase leading-4 tracking-wider text-gray-500 dark:text-gray-300">{{ __('IP Address') }}</span>
                                    </th>
                                    <th class="bg-gray-50 dark:bg-gray-600 px-6 py-3 text-left">
                                        <span class="text-xs font-medium uppercase leading-4 tracking-wider text-gray-500 dark:text-gray-300">{{ __('Time Spent') }}</span>
                                    </th>
                                ...
                                @forelse($tests as $test)
                                    <tr class="bg-white dark:bg-gray-900">
                                        ...
                                        <td class="px-6 py-4 text-sm leading-5 text-gray-900 dark:text-gray-100 whitespace-no-wrap text-end">
                                            <x-button-link :href="route('results.show', $test)" style="secondary">
                                                <span>
